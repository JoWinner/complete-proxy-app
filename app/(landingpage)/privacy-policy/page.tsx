      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Soplano LLC, Pokuase, Accra.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Soplano, accessible from{" "}
            <a
              href="https://www.soplano.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.soplano.com
            </a>
          </p>
        </li>
        <li>
