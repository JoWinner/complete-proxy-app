...
export const columns = (
  onImageClick: (rowData: StoreOrdersColumn) => void
): ColumnDef<StoreOrdersColumn>[] => [
  {
  ...
  {
    id: "actions",
    cell: ({ row }) => <CellAction data={row.original} orderDetails={row.original} />,
  },
];
